...
public class bos {
    ...
    /*
        ...
        */
        ...
        double normalTutar = (mesafe * KmBasi);
...
//
        ...
        double gidisDonusTutar=(indirimliTutar-gidisDonusIndirim);
        ...
        switch (secim) {
            case 1:
                if (yas<=12){
                    ...
                    System.out.print("Bilet Fiyatiniz : " + indirimliTutar);
                }
        }
    }
}
