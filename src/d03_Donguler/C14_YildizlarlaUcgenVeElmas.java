...
public class C14_YildizlarlaUcgenVeElmas {
    public static void main(String[] args) {
        ...
        for (i=1;i<=n;i++)//Bu döngümüzde baklava dilimimizin üst kısmını yapıyoruz.
        {
            ...
            for (j = 1; j <=i ; j++)//bu for döngümüzde ise yıldız şeklimizi çıkartıyor ve yıldızların arasındaki
                                    // boşluğu ayarlıyor
            {
                System.out.print("*"+" ");
            }
...
//bu döngümüz ile baklava diliminin alt kkısımını yapıyoruz
        for (k=1;k<=n;k++)
        {
            ...
            for (m = n; m >k ; m--)//bu döngümüz ile baklava diliminin alt kısımındaki yıldızları ve arasındaki
